...
const InputBar = ({ onSendMessage, isLoading, documentUrl, setDocumentUrl, inputText, setInputText, onUploadModeClick, showUploadDevMessage }) => {
  ...
  return (
    <div className="input-section">
      ...
      <form onSubmit={handleSubmit} className="prompt-form">
        ...
        <button
          type="submit"
          disabled={!inputText.trim() || isLoading || uploading || (!documentUrl.trim())}
